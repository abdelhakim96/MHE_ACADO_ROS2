...
void NMHENode::publish_uvw_FxFyFz( NMHE_FXFYFZ::estimation_struct& estimationstruct) {
   ...
   std::cout<<estimationstruct.u_est;
    ...
    std::vector<double> F_dist_vec = {estimationstruct.Fx_dist_est*2, estimationstruct.Fy_dist_est*2, estimationstruct.Fz_dist_est};
...
NMHENode::NMHENode() : Node("nmhe_node")
{
    ...
    this->nmhe_struct.W <<  1000.0, 100.0, 10000.0, 100000.0, 10000.0, 10000.0; // weights
